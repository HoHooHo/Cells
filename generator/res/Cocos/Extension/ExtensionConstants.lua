...
cc.SCROLLVIEW_SCRIPT_ENDED  = 2
cc.TABLECELL_TOUCHED        = 3
cc.TABLECELL_HIGH_LIGHT     = 4
cc.TABLECELL_UNHIGH_LIGHT   = 5
cc.TABLECELL_WILL_RECYCLE   = 6
cc.TABLECELL_SIZE_FOR_INDEX = 7
cc.TABLECELL_SIZE_AT_INDEX  = 8
cc.NUMBER_OF_CELLS_IN_TABLEVIEW = 9
