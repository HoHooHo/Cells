...
if not json then
    require "res/Cocos.Cocos2d.json"
end

ccs = ccs or {}

require "res/Cocos.CocoStudio.StudioConstants"
    ...
    if nil ~= cons then
        ...
        for i = 1, count do
            ...
            if nil ~= className then
                ...
                assert(nil ~= obj, string._format("class named %s can not implement!",className))
    ...
    if nil ~= actions then
        ...
        for i = 1,count do
            ...
            if nil ~= className then
                ...
                assert(nil ~= act ,string._format("class named %s can not implement!",className))
